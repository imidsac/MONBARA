...
echo '<td align="center">'.$nom_bo.'  '.$prenom_bo.' </td>';
echo '</tr>';
echo '<tr>';
...
echo '<tr class="header2 lgauche bw">
			...
			<th align="center">Q.T-LIVRAIS</th>
			<th align="center">Q.T-R.LIVRAIS</th>
...
while ($ligne=pg_fetch_assoc($resultat1))
 {
	...
	echo '<td class=" lcentre">'.$ligne['reste'].'</td>';
	echo '<td class=" ldroite">'.$ligne['prix_vente'].'<sup>F</sup></td>';
	echo '<td class=" ldroite">'.$ligne['montant'].'<sup>F</sup></td>';
