...
<div id="content">
    ...
    <div id="colTwo">
            ...
            <strong>
                <table align="center">
                    <tr>
                        <td>
                            <h5 class="titre2">
                                - : : : VOTRE ESPACE PRIVE &quot;<span
                                    class="donnee"><?php echo $_SESSION['gecos']; ?></span>&quot; : : : -
                            </h5>
                        </td>
                    <tr>
                        <td>
        ...
        <p>Bienvenue &quot;<span class="donnee"><?php echo $_SESSION['prenom']; ?></span> <span
                class="donnee"><?php echo $_SESSION['nom']; ?></span>&quot; dans votre espace gestionnaire;. <br>
            Vous &ecirc;tes connect&eacute; en tant que &quot;<span
                class="donnee"><?php echo $_SESSION['login']; ?></span>&quot; avec le privil&egrave;ge &quot;<span
                class="donnee"><?php echo $_SESSION['privilege']; ?></span>&quot;.<br>
        </p>
        ...
        <img src="images/bara/1.jpg" width="50%" height="83%" alt="" border="0"/>
        <img src="images/bara/2.jpg" width="49%" height="83%" alt="" border="0"/>
    </div>
