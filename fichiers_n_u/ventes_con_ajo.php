...
include_once('connection.php');
	...
	*/
	...
	$rventes=pg_query($connexion, "SELECT max(id_ve) as id_ve from ventes");
	$lventes=pg_fetch_assoc($rventes);
	$id_ve=$lventes['id_ve'];
?>
...
<td colspan="2" align="center" class="som">
