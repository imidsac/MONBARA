...
$id_fac=$_GET['id_fac'];
	...
	function num_facture($id_fac){
		if($id_fac<10) 	return '<strong style="color:red">0000'.$id_fac.'</strong>';
		elseif($id_fac>=10 && $id_fac<100) 	return '<strong style="color:red">000'.$id_fac.'</strong>';
		elseif($id_fac>=100 && $id_fac<1000) 	return '<strong style="color:red">00'.$id_fac.'</strong>';
		elseif($id_fac>=1000 && $id_fac<10000) 	return '<strong style="color:red">0'.$id_fac.'</strong>';
		elseif($id_fac>=10000 && $id_fac<100000) 	return '<strong style="color:red">0'.$id_fac.'</strong>';
		else 		return '<strong style="color:red">'.$id_fac.'</strong>';
	}
	//$id_fac=$_GET['id_fac'];
	$nom_cl=$_GET['nom_cl'];
...
<table  class="w1 b0" cellspacing="1mm" cellpadding="0">
		<tr>	<td class="myalg cl3 t2" style="width: 5%"></td>
			...
			<td class="myalg cl3 t2" ><?php echo $nom_cl.' '.$prenom_cl. '<br />  '.$tel1_cl. '<br />  '.$add_cl ?></td>
			<td class="myalg cl1 t2" >Facture numero :</td>
			<td class="myalg cl3 t2" ><?php echo num_facture($id_fac)?></td>
			<td class="myalg cl1 t2" > <?php echo $date_fac.'<br /> A '.$boutique?></td>
		</tr>
</table>
...
?>
		...
		<tr>
		<th colspan="4" align="left" class="prix">ACCOMPTE</th> 
