...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_langue           = 'UTF-8';        // locale of the messages
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='UTF-8', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
