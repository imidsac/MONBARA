...
<div id="content">
	...
	<div id="colTwo">
	<!-- <h1><strong>SUPPRESSION DE PRODUIT</strong></h1> -->
	
	<table style="width:40%" class="ui-widget ui-widget-content" cellspacing="0" cellpadding="10">
	<tr class="header3 bw"><th colspan="8"><h5 align="center" class="titre1">SUPPRESSION DE PRODUIT</h5></th></tr>
<tr>
...
<table><tr><td><form action="produit.php" method="post">
...
<input type="submit" name="val" value="Valider" id="myb" class="ui-state-active ui-corner-all boutons" />
	...
	<td valign="top"><a href="produit.php">
